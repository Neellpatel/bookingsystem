      ...
      <div class="mx-auto max-w-7xl px-5 sm:px-8 py-10 grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
        <div>
          ...
          <div class="flex items-center gap-2.5 mt-5">
            ...
            <a href="https://www.instagram.com/neelpxtell?igsh=MWVydXMyM2RvNGlhYg==" target="_blank" rel="noopener" aria-label="Instagram" title="Instagram" class="w-9 h-9 rounded-full bg-white/10 border border-white/10 flex items-center justify-center text-white/70 hover:text-white hover:bg-teal transition active:scale-90">
            ...
            <a href="https://www.youtube.com/@indusuniversity1914" target="_blank" rel="noopener" aria-label="YouTube" title="YouTube" class="w-9 h-9 rounded-full bg-white/10 border border-white/10 flex items-center justify-center text-white/70 hover:text-white hover:bg-teal transition active:scale-90">
